...
class TestPup3():
  ...
  def test_pup3(self):
    ...
    self.driver.find_element(By.NAME, "group_name").send_keys("pup3")
    self.driver.find_element(By.NAME, "group_header").click()
    self.driver.find_element(By.NAME, "group_header").send_keys("jyyutiug")
    self.driver.find_element(By.NAME, "group_footer").click()
    self.driver.find_element(By.NAME, "group_footer").send_keys("jhgjhg")
