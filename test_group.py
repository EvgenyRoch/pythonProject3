...
class TestGroup():
  ...
  def test_group(self):
    ...
    self.driver.find_element(By.NAME, "group_name").send_keys("jgfjyuygiuy")
    self.driver.find_element(By.NAME, "group_header").click()
    self.driver.find_element(By.NAME, "group_header").send_keys("kgkhkj")
    self.driver.find_element(By.NAME, "group_footer").click()
    self.driver.find_element(By.NAME, "group_footer").send_keys("kgkhlij;")
